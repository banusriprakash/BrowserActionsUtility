...
## 📌 Overview
The **BrowserActions** class acts as the **Intelligence Layer** of a Selenium automation framework. It abstracts complex WebDriver commands into simpaale, reusable methods, focusing on three core pillars: **Synchronization**, **Visibility**, and **Traceability**.
